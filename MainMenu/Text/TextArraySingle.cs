...
namespace MainMenu.Text
{
    public static class TextArraySingle
    {
        ...
        public static string[][] ArraySingleTextAnswers(string[][] dataText, int x = 8, int i = 0)
        {
            ...
            dataText[x][i++] = "\nИндекс минимального значение массива: ";
            dataText[x][i++] = "\nИндекс максимального значение массива: ";
            ...
            dataText[x][i++] = "\nЗаменив местами первую и вторую половину массива, получили массив данного вида: ";
