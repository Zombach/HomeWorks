...
namespace MainMenu.Tests.ArrayTwoDimensionalTestsFolders
{
    ...
    public class ArrayTwoDimensionalTests_Q4
    {
        [TestCase(1)]
        [TestCase(2)]
        [TestCase(3)]
        ...
        public void Quest(int numberMock)
        {
            ...
            double[] actual = ArrayTwoDimensional_Q4.Quest(tmp);
            double[] expected = GetMockArrayTwoDimensionalTests.GetExpectedMock_Q4(numberMock);
