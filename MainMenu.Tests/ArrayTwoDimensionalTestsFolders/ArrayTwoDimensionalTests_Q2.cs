...
namespace MainMenu.Tests.ArrayTwoDimensionalTestsFolders
{
    ...
    public class ArrayTwoDimensionalTests_Q2
    {
        [TestCase(1)]
        [TestCase(2)]
        [TestCase(3)]
        ...
        public void Quest(int numberMock)
        {
            ...
            double[] actual = ArrayTwoDimensional_Q2.Quest(tmp);
            double[] expected = GetMockArrayTwoDimensionalTests.GetExpectedMock_Q2(numberMock);
