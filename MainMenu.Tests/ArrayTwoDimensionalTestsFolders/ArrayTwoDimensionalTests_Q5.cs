...
namespace MainMenu.Tests.ArrayTwoDimensionalTestsFolders
{
    ...
    public class ArrayTwoDimensionalTests_Q5
    {
        ...
        public void Quest(int numberMock)
        {
            ...
            double[] actual = ArrayTwoDimensional_Q5.Quest(tmp);
            double[] expected = GetMockArrayTwoDimensionalTests.GetExpectedMock_Q5(numberMock);
